...
def make_block(channels, kernel_size=1):
...
class DinoDisc(nn.Module):
    def __init__(self, device: torch.device, dino_ckpt_path: str):
        super().__init__()
        ...
        key_depths = (2, 5, 8, 11)
        dino = FrozenDINONoDrop(depth=12, key_depths=key_depths, norm_eps=1e-6,
                              patch_size=8, in_chans=3, embed_dim=384,
